  ...
  module Resources
    class Resource
      ACTIVE_SCAFFOLD_ROUTING = {
        :collection => {:show_search => :get, :update_table => :get, :edit_associated => :get, :list => :get, :new_existing => :get, :print_html => :get, :print_pdf => :get, :show_customize => :get, :show_export_tool => :get, :reset_search => :get, :refresh => :get, :reset_customize => :get, :customize => :get, :export_tool => :get},
